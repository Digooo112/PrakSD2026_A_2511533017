...
public class Browser_2511533017 {
	// Method statis untuk menampilkan pilihan menu browser kepada pengguna.
	public static void tampilkanMenu_2511533017() {
		System.out.println("\n\n======= Menu BROWSER  NIM : 2511533017 ======");
	...
	public static void tambahBrowser_2511533017(Stack<WebSite_2511533017>list, Scanner zs) {
		System.out.print("Masukkan Judul Website: ");
		String judulweb_3017 = zs.nextLine(); // Membaca input string satu baris penuh dari pengguna.
		System.out.print("Masukkan URL Website: ");
		String urlweb_3017 = zs.nextLine();
		list.push(new WebSite_2511533017 (judulweb_3017,urlweb_3017)); // Push menambahkan elemen ke puncak stack.
		System.out.print("\n Berhasil mengunjungi halaman website! :D");
	}
	
	// Method untuk menghapus halaman terakhir dari history menggunakan operasi pop.
	public static void tombolBack_2511533017(Stack<WebSite_2511533017> list) {
		if (!list.isEmpty()) { // Kondisi ini memeriksa apakah stack tidak kosong sebelum diakses.
			WebSite_2511533017 halamanKembali = list.pop(); // Pop menghapus dan mengembalikan elemen teratas stack.
	...
	public static void lihatHalaman_2511533017(Stack<WebSite_2511533017> list) {
		System.out.println("\n========================== STATUS BROWSER =========================");
		...
		if (list.isEmpty()) {
			...
			WebSite_2511533017 halamanAktif= list.peek(); // Peek mengembalikan elemen teratas tanpa menghapusnya.
	...
	public static void main(String[] args) { // Method main adalah titik entry eksekusi program Java.
			Stack<WebSite_2511533017> historyBrowser = new Stack<>(); // Inisialisasi objek Stack dengan tipe data generik Website.
			...
			do { // Loop do-while memastikan blok kode dijalankan minimal satu kali sebelum pengecekan kondisi.
				...
				switch (choice) { // Switch-case memilih blok kode yang akan dieksekusi berdasarkan nilai variabel choice.
					case 1:
						tambahBrowser_2511533017(historyBrowser, scanner);
						break; // Break menghentikan fall-through agar case lain tidak ikut dieksekusi.
					case 2:
						tombolBack_2511533017(historyBrowser);
						break;
					case 3:
						lihatHalaman_2511533017(historyBrowser);
						break;
					case 4:
