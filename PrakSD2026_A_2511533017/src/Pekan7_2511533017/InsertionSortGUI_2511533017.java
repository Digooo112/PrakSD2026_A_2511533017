...
public class InsertionSortGUI_2511533017 extends JFrame {
	...
	public InsertionSortGUI_2511533017() {
	...
	private void performStep_3017() {
		if (i_3017 < array_3017.length && sorting_3017) {
			int key_3017 = array_3017[i_3017];
			j_3017 = i_3017 - 1;
			...
			while (j_3017 >= 0 && array_3017[j_3017] > key_3017) {
				array_3017[j_3017 + 1] = array_3017[j_3017];
				j_3017--;
			}

			array_3017[j_3017 + 1] = key_3017;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertionSortGUI_2511533017 frame = new InsertionSortGUI_2511533017();
